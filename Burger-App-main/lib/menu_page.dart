...
class _MenuPageState extends State<MenuPage> {
  ...
  late List rating = ["4.8", "4.2", "4.7", "4.3","5.0"];
  late List price = ["30/only", "25/only", "35/only", "20/only", "25/only"];
  late List timing = ["5-6 min", "4-5 min", "6-7 min", "5-7 min", "6-7 min"];
  late List topics = ["Cheese", "Veggie", "Crispy", "Topping", "Topping"];
